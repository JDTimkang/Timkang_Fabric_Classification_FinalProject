...
class _HistoryPageState extends State<HistoryPage> {
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Search by fabric type...',
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    const Text(
                      'Go to Detect tab to start scanning fabrics',
                      style: TextStyle(
                        fontSize: 14,
                        color: AppColors.textSecondary,
                      ),
  ...
  Widget _buildRecordCard(BuildContext context, DetectionRecord record) {
    ...
    final fabricName = record.predictedClass;
    final assetPath = 'assets/images/$fabricName.png';
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            // Selection thumbnail or fabric photo thumbnail
            if (_isSelectionMode)
              Container(
                width: 52,
                height: 52,
